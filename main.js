...
function addDemoData() {
  addBookToLibrary('Shadow and Bone', 'Leigh Bardugo', '416', true);
  addBookToLibrary('Siege and Storm', 'Leigh Bardugo', '496', true);
  addBookToLibrary('Ruin and Rising', 'Leigh Bardugo', '480', true);
  ...
  addBookToLibrary('All My Rage', 'Sabaa Tahir', '384', false);
}
